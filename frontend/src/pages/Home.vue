<template>
  <div class="banner-section d-flex flex-column pa-15">
    <v-container>
      ...
      <p class="banner-subtitle mt-10">
        Dieser Metadatentkatalog hilft Ihnen, offene Datensätze zu finden, die
  ...
  <v-container>
    ...
    <p class="pl-10 ml-10 text-body-1 mt-5">
      ...
      verschneiden lassen, zum Beispiel über räumlichen oder zeitlichen Bezug
      oder über Altersgruppe und Geschlecht. Die Anwendung erlaubt ebenfalls
      eine Filterung nach Thema und bereitet die offenen Daten automatisch in
      einem kompatiblen Format vor – bereit für eine nahtlose Integration mit
      Ihren MII-Daten.
    </p>
  ...
  <v-row justify="center">
    <v-col cols="12" lg="12" xl="9" xxl="8" class="bg-home-white">
      ...
      <p class="pl-10 ml-10 text-body-1 mt-5 mb-10">
        ...
        sozioökonomische Faktoren und demografische Merkmale das Leben und die
        Erholung von Long-COVID-Betroffenen beeinflussen. Filtern und sortieren
